...
The deployment url is: [https://arquisoft.github.io/wiq_es05b/](https://arquisoft.github.io/wiq_es05b/).
...
If we want to deploy it to GitHub pages, so it is accessible via [https://arquisoft.github.io/wiq_es05b/](https://arquisoft.github.io/wiq_es05b/), we need to execute `npm run deploy`.
